...
VALUES (uid, tid, 'match', '2025-08-17', 'מול Manchester United', 1, 0, 90,
  'ניצחון פתיחה מאומץ באולד טראפורד',
  'הגנה אטומה למרות לחץ של יונייטד. קלאפיורי ניצל קורנר של רייס בצורה מושלמת. זובימנדי שלט בקו האמצע וניתב את הבנייה בביטחון.',
  'קצב בנייה מהיר מדי בחצי הראשון הוביל לאיבודים מיותרים. סאקה היה מוגבל בצד ימין מול דורגו שהציק לו.',
  'ארטטה שינה את גישת הבנייה — קצב מסירה ממוצע של 2.02 מטר לשנייה, 55% מהר מהממוצע. ג''וקרש כחלוץ מסיים שינה את הדינמיקה ההתקפית.',
  'לשפר את השליטה בחצי השני. לעבוד על מעברי הגנה-התקפה מהירים יותר.',
  4)
...
שחקנים בולטים: זובימנדי — שליט מוחלט. קלאפיורי — גולקיק. רייס — מסירת הקורנר שהכריעה.',
  '[
  ...
  '{"summary": "ניצחון אופייני של ארטטה — סבלנות, משמעת, ורגע קסם מקורנר. הגנה אטומה למרות לחץ רציף של יונייטד.", "positives": ["הגנה מוצקה ומשמעתית", "ניצול מושלם של סט-פיס", "זובימנדי שלט בקו האמצע"], "issues": ["איבודים מבנייה מהירה מדי", "סאקה מוגבל ב-1 על 1 בצד ימין", "קצב ירד בחצי השני"], "recommendations": ["לעבוד על מעברי הגנה-התקפה", "פתרונות חלופיים לסאקה כשנחסם"]}'
);
...
-- =============================================
INSERT INTO public.professional_summaries (user_id, team_id, event_type, event_date, event_label, result_our, result_opponent, duration_minutes, topic, what_worked, issues_found, tactical_insights, decisions_next, satisfaction)
VALUES (uid, tid, 'match', '2025-08-23', 'מול Leeds United', 5, 0, 90,
  'ניצחון מוחץ בבית — ג''וקרש עם דאבל בבכורה ביתית',
  'טימבר מצוין עם שני שערים וסיוע. ג''וקרש סיים דאבל. הקורנרים שוב קטלניים. מקס דאומן בן ה-15 קיבל דקות.',
  'החמצה גדולה של ג''וקרש במחצית הראשונה. סאקה ואודגארד ירדו עם בעיות פיזיות קלות — יש לעקוב.',
  'לידס לא הצליחו להתמודד עם הקורנרים. טימבר כמגן ימין תומך נכנס עמוק לרחבה פעמיים. ג''וקרש הראה יכולת תגובה אחרי החמצה.',
  'לנהל עומסים לפני ליברפול חוץ. לוודא שסאקה ואודגארד מוכנים.',
  5)
RETURNING id INTO sid;
...
רגע מיוחד: מקס דאומן בן 15 ו-234 ימים נכנס כמחליף — השני הצעיר בהיסטוריה של הקבוצה. זכה בפנדל בתוספת הזמן.',
  '[
  ...
  '{"summary": "ניצחון מוחץ 5-0 שהראה את העוצמה ההתקפית ואת הקטלניות מקורנרים. ג''וקרש וטימבר היו יוצאי דופן.", "positives": ["טימבר עם דאבל + סיוע", "קטלניות מקורנרים ברמה חסרת תקדים", "ג''וקרש דאבל בבכורה ביתית", "דאומן בן 15 מקבל הזדמנות"], "issues": ["החמצה גדולה של ג''וקרש בהתחלה", "חששות פיזיים קלים אצל סאקה ואודגארד"], "recommendations": ["ניהול עומסים לפני ליברפול", "לשמור על אינטנסיביות גם בתוצאות גבוהות"]}'
);
...
-- =============================================
INSERT INTO public.professional_summaries (user_id, team_id, event_type, event_date, event_label, result_our, result_opponent, duration_minutes, topic, what_worked, issues_found, tactical_insights, decisions_next, satisfaction)
VALUES (uid, tid, 'match', '2025-08-31', 'מול Liverpool', 0, 1, 90,
  'הפסד מתסכל באנפילד — בעיטה חופשית של סובוסלאי ב-83',
  'ההגנה החזיקה 82 דקות למרות פציעת סליבא בדקה 4. מוסקרה נכנס והתמודד בכבוד.',
  'סליבא נפצע אחרי 4 דקות. הקבוצה לא הצליחה ליצור מספיק בהתקפה. חוסר אפקטיביות התקפית.',
  'ליברפול שלטו בחזקה אבל לא שברו את ההגנה עד בעיטה חופשית מ-30 מטר. אזה נכנס לבכורה אבל לא הספיק להשפיע. ההגנה הייתה מצוינת עד הרגע הגורלי.',
  'בדיקת סליבא — חייבים אותו בחזרה. מוסקרה הראה שהוא אופציה אמינה. לעבוד על מצבי בעיטה חופשית הגנתיים.',
  2)
RETURNING id INTO sid;
...
לקח: הפסד כואב אבל ההגנה בלי סליבא הראתה עומק. מוסקרה אופציה רצינית.',
  '[
  ...
  '{"summary": "הפסד 0-1 מתסכל מבעיטה חופשית בדקה 83. ההגנה הייתה גיבורית 82 דקות אבל ההתקפה לא יצרה.", "positives": ["הגנה יציבה 82 דקות", "מוסקרה מצוין כמחליף חירום לסליבא", "משמעת קבוצתית גבוהה"], "issues": ["חוסר יצירתיות בהתקפה", "ג''וקרש בודד", "בעיטה חופשית לא נחסמה"], "recommendations": ["לעבוד על תמיכת חלוץ במשחקי חוץ גדולים", "תרגול הגנה על בעיטות חופשיות", "בדיקת סליבא"]}'
);
...
-- =============================================
INSERT INTO public.professional_summaries (user_id, team_id, event_type, event_date, event_label, result_our, result_opponent, duration_minutes, topic, what_worked, issues_found, tactical_insights, decisions_next, satisfaction)
VALUES (uid, tid, 'match', '2025-09-13', 'מול Nottingham Forest', 3, 0, 90,
  'זובימנדי עם דאבל ראשון בקריירה — ניצחון מוצק 3-0',
  'זובימנדי גול ווולי מחוץ לרחבה + נגיחה. אזה בבכורה ביתית סייע לג''וקרש. ראיה הגיע ל-100 הופעות.',
  'אודגארד ירד פצוע בכתף אחרי 17 דקות — בעיית זמינות חוזרת. סליבא לא חזר, מוסקרה המשיך.',
  'בלי אודגארד, מרינו נכנס לעשר ואזה ירד שמאלה — הגמישות הטקטית עבדה מצוין. 3-0 בלי הקפטן.',
  'בדיקת אודגארד — כתף ימין. להמשיך עם מוסקרה בלב ההגנה. אזה מראה שהוא חיזוק אמיתי.',
  5)
RETURNING id INTO sid;
...
שחקנים בולטים: זובימנדי — ביצוע עולמי. אזה — בכורה ביתית מבטיחה מאוד.',
  '[
  ...
  '{"summary": "ניצחון 3-0 מרשים בלי אודגארד. זובימנדי עם דאבל ראשון בקריירה, אזה מבטיח בבכורה.", "positives": ["זובימנדי עם דאבל — וולי + נגיחה", "אזה בכורה ביתית מוצלחת", "קלין שיט שביעי", "ניצחון בלי הקפטן"], "issues": ["אודגארד נפצע שוב — כתף ימין", "סליבא עדיין חסר"], "recommendations": ["ניהול עומסים לאודגארד", "להמשיך עם מוסקרה כשסליבא לא זמין"]}'
);
...
-- =============================================
INSERT INTO public.professional_summaries (user_id, team_id, event_type, event_date, event_label, result_our, result_opponent, duration_minutes, topic, what_worked, issues_found, tactical_insights, decisions_next, satisfaction)
VALUES (uid, tid, 'match', '2025-09-21', 'מול Manchester City', 1, 1, 90,
  'תיקו דרמטי 1-1 — מרטינלי השווה בתוספת הזמן',
  'האופי לא למות — מרטינלי נכנס מהספסל והשווה ב-90+3. אזה עם כדור ארוך מעולה מעל ההגנה.',
  'הלאנד כבש אחרי 8 דקות בלבד — הגנה לא ערוכה. 5 נקודות מאחורי ליברפול. שליטה בחזקה ירודה מול סיטי.',
  'סיטי שלטו בחצי הראשון. ארסנל השתפרו בהדרגה ולחצו בסוף. מרטינלי מהספסל הוכיח את עוצמת העומק. אזה כמי שמנתב כדור עומק ארוך — שימוש מפתיע ואפקטיבי.',
  'לנתח למה ההגנה לא הייתה ערוכה לפתיחה. לשמור על שילובי הספסל — מרטינלי חייב דקות.',
  3)
RETURNING id INTO sid;
...
לקח: נקודה שמרגישה כמו ניצחון בהקשר, אבל 1-1 בבית מול סיטי זה לא מספיק לתואר.',
  '[
  ...
  '{"summary": "תיקו 1-1 דרמטי — הלאנד כבש מוקדם, מרטינלי השווה בתוספת הזמן מכדור ארוך של אזה.", "positives": ["אופי ונחישות עד הסוף", "מרטינלי מהספסל — אקדח טעון", "אזה עם כדור ארוך מבריק"], "issues": ["ההגנה לא ערוכה בפתיחה", "הלאנד קיבל מרחב", "חוסר יצירתיות עד הסוף"], "recommendations": ["תרגול התארגנות בפתיחת משחק", "ניטרול חלוצים פיזיים כמו הלאנד"]}'
);
...
-- =============================================
INSERT INTO public.professional_summaries (user_id, team_id, event_type, event_date, event_label, result_our, result_opponent, duration_minutes, topic, what_worked, issues_found, tactical_insights, decisions_next, satisfaction)
VALUES (uid, tid, 'match', '2025-09-28', 'מול Newcastle United', 2, 1, 90,
  'קאמבק מטורף בסנט ג''יימס פארק — גבריאל ניצח ב-90+',
  'מרינו ניגח השוואה ב-84, גבריאל ניצח מקורנר של אודגארד בתוספת הזמן. אודגארד חזר כמחליף!',
  'וולטמדה כבש לניוקאסל בדקה 34. ארסנל הפגינו חולשה בהגנה על תנועות אלכסוניות.',
  'המהלך הטקטי המכריע: הכנסת אודגארד שחזר מפציעה בדקה 70. הקפטן שינה את המשחק — הכניס את הקורנר שממנו גבריאל ניצח.',
  'אודגארד חוזר — זה משנה הכל. ניוקאסל חשפו חולשות בהגנה שצריך לתקן. הסט-פיסים שוב מכריעים.',
  5)
RETURNING id INTO sid;
...
## סט-פיסים
שוב הסט-פיסים הכריעו: מרינו ניגח מאספקה של רייס (84''). גבריאל ניגח מקורנר של אודגארד (90+''). שני שערי נגיחה — DNA של ארסנל.
...
שחקנים בולטים: גבריאל — גיבור עם הנגיחה המנצחת. מרינו — ניגח להשוואה. אודגארד — שינה את המשחק ב-20 דקות מהספסל.',
  '[
...
-- =============================================
INSERT INTO public.professional_summaries (user_id, team_id, event_type, event_date, event_label, result_our, result_opponent, duration_minutes, topic, what_worked, issues_found, tactical_insights, decisions_next, satisfaction)
VALUES (uid, tid, 'match', '2025-10-04', 'מול West Ham United', 2, 0, 90,
  'ארסנל בראש הטבלה — רייס וסאקה מכריעים',
  'רייס כבש גול נפלא, סאקה הכפיל מפנדל. ארסנל עלו לראש הטבלה לראשונה העונה. קלין שיט שביעי בליגה.',
  'מחצית ראשונה שמרנית מדי — השער הגיע רק בדקה 37. צריך לפתוח משחקים חזק יותר.',
  'רייס משחק חופשי יותר — ארטטה נותן לו לעלות. זה נותן פרי. סאקה קר מהנקודה. סליבא ובן ווייט חזרו להגנה — יציבות מלאה.',
  'ניצחון שמרני אבל אפקטיבי. להמשיך עם הקצב הזה. לנצח בפולהאם ולשמור על פער.',
  4)
RETURNING id INTO sid;
...
תחושה: ניצחון מקצועי. לא מרגש, אבל בראש הטבלה — זה מה שחשוב.',
  '[
  ...
  '{"summary": "ניצחון מקצועי 2-0 שהעלה את ארסנל לראש הטבלה. רייס כבש גול נפלא וסאקה הכפיל מפנדל.", "positives": ["ארסנל בראש הטבלה", "חזרת סליבא", "רייס גול יפהפה", "סאקה קר מהנקודה"], "issues": ["פתיחה שמרנית — שער רק בדקה 37"], "recommendations": ["להתחיל משחקים באינטנסיביות גבוהה יותר"]}'
);
...
-- =============================================
INSERT INTO public.professional_summaries (user_id, team_id, event_type, event_date, event_label, result_our, result_opponent, duration_minutes, topic, what_worked, issues_found, tactical_insights, decisions_next, satisfaction)
VALUES (uid, tid, 'match', '2025-10-18', 'מול Fulham', 1, 0, 90,
  'טרוסארד כובש מקורנר — ניצחון צר וחשוב ב-Craven Cottage',
  'הקורנרים שוב מכריעים — גבריאל הנגיח, טרוסארד סיים. קלין שיט שמיני מ-11 משחקים. הובלה של 3 נקודות בפסגה.',
  'סאקה הופל ברחבה — VAR ביטל פנדל אחרי צפייה חוזרת. פולהאם לא בעטו אף פעם על המסגרת.',
  'טרוסארד מהספסל כובש — עומק התקפי אמיתי. 37 שערים מקורנרים מאז תחילת 23-24 — 16 יותר מכל קבוצה אחרת בליגה.',
  'ניצחון צר אבל שליטה מלאה. 63% חזקה. 5 בעיטות למסגרת מול 0 של פולהאם.',
  4)
RETURNING id INTO sid;
...
VALUES (uid, tid, sid, 'Fulham', '2025-10-18',
  ...
  ARRAY['freeform'],
  '## ניתוח טקטי
ארסנל שלטו בקרייבן Craven Cottage. 63% חזקה, 5 בעיטות למסגרת מול 0 של פולהאם. ניצחון צר אבל שליטה מוחלטת.
...
לקח: 3 נקודות ראש הטבלה. הולכים בדרך הנכונה.',
  '[
  ...
  '{"summary": "ניצחון צר 1-0 בפולהאם מגול של טרוסארד מקורנר. שליטה מוחלטת — 63% חזקה, 5 בעיטות למסגרת מול 0.", "positives": ["שליטה מוחלטת", "קורנר קטלני שוב", "טרוסארד מהספסל כובש", "קלין שיט שמיני"], "issues": ["צריך לכבוש יותר כששולטים", "VAR ביטל פנדל לגיטימי"], "recommendations": ["יותר נחישות ברחבה", "לסיים מצבים"]}'
);
...
-- =============================================
INSERT INTO public.professional_summaries (user_id, team_id, event_type, event_date, event_label, result_our, result_opponent, duration_minutes, topic, what_worked, issues_found, tactical_insights, decisions_next, satisfaction)
VALUES (uid, tid, 'match', '2025-10-26', 'מול Crystal Palace', 1, 0, 90,
  'אזה כובש מול הקבוצה הישנה שלו — ניצחון רביעי ברציפות',
  'אזה כבש בווליי אקרובטי מנגיחת גבריאל — גול ראשון לקבוצה. קלין שיט עשירי מ-13 משחקים. הובלה של 4 נקודות.',
  'ארסנל המתינו 33 דקות לבעיטה ראשונה — ההמתנה הארוכה ביותר מאז אפריל 2021. פאלאס לא בעטו למסגרת.',
  'ניצחון שמרני אבל מקצועי. ההגנה היא הנשק הראשי — 3 שערים בלבד ב-13 משחקים בכל המסגרות.',
  'ניצחון רביעי ברציפות. 4 נקודות מעל בורנמות\' ו-6 מעל סיטי. אזה מתחבר.',
  4)
RETURNING id INTO sid;
...
לקח: ארסנל של ארטטה מנצחת 1-0 כמו מכונה. השאלה היא אם זה יספיק מול הגדולים.',
  '[
  ...
  '{"summary": "ניצחון רביעי ברציפות 1-0. אזה כבש מול הקבוצה הישנה בווליי אקרובטי. קלין שיט עשירי ב-13 משחקים.", "positives": ["אזה גול ראשון — רגע מיוחד", "קלין שיט עשירי", "4 נקודות פער בפסגה"], "issues": ["33 דקות ללא בעיטה", "תלות בסט-פיסים", "חוסר יצירתיות ממשחק פתוח"], "recommendations": ["לתרגל פריצות מול בלוק נמוך", "לגוון את דרכי ההגעה לשער"]}'
);
...
-- =============================================
INSERT INTO public.professional_summaries (user_id, team_id, event_type, event_date, event_label, result_our, result_opponent, duration_minutes, topic, what_worked, issues_found, tactical_insights, decisions_next, satisfaction)
VALUES (uid, tid, 'match', '2025-11-01', 'מול Burnley', 2, 0, 90,
  'ג''וקרש ורייס כבשו — 9 ניצחונות ברציפות בכל המסגרות',
  'ג''וקרש מקורנר ורייס עם נגיחה — 2-0 כבר בהפסקה. דוברבקה הציל 2 בעיטות של סאקה. קלין שיט.',
  'מחצית שנייה שאננה מדי — ארסנל ירדו עם עין על צ''מפיונס ליג. ברנלי כמעט כבשו מנגיחת פלורנטינו לואיש.',
  'ארסנל ניהלו את המשחק בצורה בוגרת. 2-0 בהפסקה ושליטה בלי סיכון במחצית השנייה. 9 ניצחונות רצופים.',
  'ניצחון מקצועי. ניהול חכם עם עין על ליגת האלופות ביום שלישי. הקבוצה בכושר מעולה.',
  4)
RETURNING id INTO sid;
...
## הגנה
קלין שיט נוסף, אבל ברנלי כמעט כבשו — נגיחת פלורנטינו לואיש (73'') עפה מעל המשקוף. הבעיטה הראשונה של ברנלי למסגרת בכל המשחק.
...
סיכום: 9 ניצחונות רצופים. הקבוצה בקצב של אלופים.',
  '[
  ...
  '{"summary": "ניצחון מקצועי 2-0 בברנלי — ג''וקרש ורייס כבשו במחצית הראשונה. ניצחון תשיעי ברציפות.", "positives": ["9 ניצחונות רצופים", "ג''וקרש ורייס מסט-פיסים", "ניהול משחק בוגר", "קלין שיט"], "issues": ["מחצית שנייה שאננה", "ברנלי כמעט כבשו"], "recommendations": ["לשמור על ריכוז גם בתוצאה גבוהה"]}'
);
