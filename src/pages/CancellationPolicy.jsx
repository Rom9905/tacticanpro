        ...
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
            ...
            <section>
              ...
              <ul style={{ fontSize: 17, lineHeight: 1.7, color: '#1F2937', display: 'flex', flexDirection: 'column', gap: 6, listStyle: 'none', padding: 0, margin: 0 }}>
                <li>• המנוי העונתי פעיל עד סיום העונה — תחילת יוני (לא כולל). התשלום נגבה מדי חודש (150₪).</li>
                <li>• ניתן להודיע על ביטול בכל עת, אך החיוב החודשי ימשיך עד תום תקופת העונה (תחילת יוני, לא כולל). המערכת תישאר פתוחה לשימוש עד סוף התקופה.</li>
