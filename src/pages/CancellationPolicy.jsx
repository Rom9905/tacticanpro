      ...
      <main className="flex-1 px-6 py-16">
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
            ...
            <section>
              <h2 style={{ fontFamily: 'Heebo, sans-serif', fontWeight: 700, fontSize: 20, color: '#0D1A12', marginBottom: 12 }}>
                2. מנוי עונתי (150₪/חודש, עד סיום העונה — תחילת יוני)
              </h2>
              <ul style={{ fontSize: 17, lineHeight: 1.7, color: '#1F2937', display: 'flex', flexDirection: 'column', gap: 6, listStyle: 'none', padding: 0, margin: 0 }}>
                <li>• המנוי העונתי פעיל עד סיום העונה — תחילת יוני (לא כולל). המחיר הוא 150₪ עבור כל חודש שנותר עד תום העונה, כאשר חודש שהחל נספר כחודש מלא.</li>
                <li>• ניתן לבחור בין שתי דרכי תשלום: (א) תשלום חודשי מתחדש של 150₪, שנגבה עד תום העונה בלבד; או (ב) תשלום מלא מראש עבור יתרת העונה (150₪ × מספר החודשים שנותרו).</li>
                <li>• ניתן לבטל בכל עת דרך עמוד ניהול המנוי במערכת. בתשלום חודשי — החיוב האחרון הוא של החודש השוטף, הגישה נשמרת עד סופו ולא יבוצעו חיובים נוספים.</li>
                <li>• בתשלום מלא מראש — הגישה נשמרת עד תום העונה. לא יינתן החזר יחסי על תקופה שלא נוצלה, למעט במקרים המפורטים בחוק הגנת הצרכן.</li>
                <li>• מנוי שבוטל אינו מתחדש לעונה הבאה.</li>
              </ul>
            ...
            <section>
              ...
              <p style={{ fontSize: 17, lineHeight: 1.7, color: '#1F2937', marginBottom: 8, margin: '0 0 8px 0' }}>
                הדרך המהירה: כפתור "ביטול המנוי" בעמוד ניהול המנוי במערכת — הביטול מתבצע מיידית ואוטומטית. אפשר גם בפנייה ישירה אלינו:
              </p>
              ...
              <p style={{ fontSize: 17, lineHeight: 1.7, color: '#1F2937', marginTop: 8, margin: '8px 0 0 0' }}>
                ביטול דרך המערכת נכנס לתוקף מיידית; ביטול בפנייה — תוך יום עסקים אחד מרגע הפנייה.
              </p>
            </section>
