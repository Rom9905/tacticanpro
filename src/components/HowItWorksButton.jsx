...
export default function HowItWorksButton({ page }) {
  ...
  const content = {
    ...
    CoachAssistant: {
      title: 'עוזר מאמן',
      steps: [
        { icon: '💬', title: 'פתח שיחה חדשה', desc: 'לחץ "שיחה חדשה" בסרגל השמאלי ושאל שאלה טקטית בחלק הצ\'אט.' },
        { icon: '🎛️', title: 'בחר מצב', desc: 'שנה מצב: תשובה מהירה, תכנון שבועי, ניתוח משחק, או פיתוח שחקן.' },
        { icon: '🧠', title: 'קבל ייעוץ מותאם', desc: 'העוזר מכיר את הקבוצה שלך, השחקנים, הבעיות ומשחקים קרובים ומתאים את התשובות.' },
        { icon: '🏋️', title: 'שמור תרגילים', desc: 'על כל תרגיל שמוצע תוכל ללחוץ "הוסף לתוכנית" כדי לשמור אותו לאימונים.' },
        { icon: '📂', title: 'ניהול שיחות', desc: 'כל שיחה נשמרת. לחץ פעמיים על שם שיחה לשנות אותו. לחץ על פח למחוק.' },
      ]
    },
    TacticalBoard: {
      title: 'לוח טקטי',
